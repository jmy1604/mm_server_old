...
func (this *Player) get_personal_space(player_id int32) int32 {
	...
	result := this.rpc_call_player_get_personal_space(player_id)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_modify_signature(signature string) int32 {
	result := this.rpc_call_personal_space_modify_signature(signature)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_zan(player_id, pic_id int32) int32 {
	result := this.rpc_call_personal_space_zan(player_id, pic_id)
	if result == nil {
		return -1
	}
	if result.Error < 0 {
...
func (this *Player) personal_space_pull_leave_msg(player_id, pic_id, start_index, msg_num int32) int32 {
	...
	result := this.rpc_call_pull_personal_space_leave_msg(player_id, pic_id, start_index, msg_num)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_send_leave_msg(player_id, pic_id int32, content []byte) int32 {
	...
	result := this.rpc_call_personal_space_send_leave_msg(player_id, pic_id, content)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_delete_leave_msg(player_id, pic_id, msg_id int32) int32 {
	result := this.rpc_call_personal_space_delete_leave_msg(player_id, pic_id, msg_id)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_send_leave_msg_comment(player_id, pic_id, msg_id int32, comment []byte) int32 {
	result := this.rpc_call_personal_space_send_leave_msg_comment(player_id, pic_id, msg_id, comment)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_delete_leave_msg_comment(player_id, pic_id, msg_id, comment_id int32) int32 {
	result := this.rpc_call_personal_space_delete_leave_msg_comment(player_id, pic_id, msg_id, comment_id)
	if result == nil {
		return -1
	}
...
func (this *Player) personal_space_pull_leave_msg_comment(player_id, pic_id, msg_id, start_index, comment_num int32) int32 {
	result := this.rpc_call_personal_space_pull_leave_msg_comment(player_id, pic_id, msg_id, start_index, comment_num)
	if result == nil {
		return -1
	}
