...
const RANKING_LIST_STAGE_TOTAL_SCORE = "mm:ranking_list_stage_total_score"
const RANKING_LIST_STAGE_SCORE = "mm:ranking_list_stage_score"
const RANKING_LIST_CHARM = "mm:ranking_list_charm"
const RANKING_LIST_CAT_OUQI = "mm:ranking_list_cat_ouqi"
const RANKING_LIST_ZANED = "mm:ranking_list_zaned"
const STAGE_SCORE_RANKING_LIST_ID_SET = "mm:stage_score_ranking_list_id_set"
