...
// 大厅到大厅直接调用
func (this *HallServer) rpc_call_hall2hall(receive_player_id int32, method string, args interface{}, reply interface{}) error {
	if this.rpc_client == nil {
...
// 添加昵称，不需要返回值
func (p *Player) rpc_call_add_nick_id(nick string, id int32) error {
...
// 修改昵称
func (this *Player) rpc_call_rename_nick(old_nick, new_nick string) *rpc_common.H2R_RenameNickResult {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 基本信息修改
func (this *Player) rpc_call_update_base_info() *rpc_common.H2H_BaseInfoResult {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获得商店全服限量商品
func (this *Player) rpc_call_get_shop_limited_item(item_id int32) *rpc_common.H2R_ShopLimitedItemResult {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 购买商店限时商品
func (this *Player) rpc_call_buy_shop_limited_item(item_id int32, item_num int32) *rpc_common.H2R_BuyLimitedShopItemResult {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 刷新商店
func (this *Player) rpc_call_refresh_shop_limited_item() error {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return errors.New("!!!! rpc client is null")
	}
...
// 刷新部分商店商品
func (this *Player) rpc_call_refresh_some_shop_limited_item(items []int32) error {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return errors.New("!!!! rpc client is null")
	}
...
// 检查刷新商店
func (this *Player) rpc_call_check_refresh_shop_limited_item(days int32) error {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return errors.New("!!!! rpc client is null")
	}
...
// 查找玩家
func (this *Player) rpc_call_search_friend(nick string) (result *rpc_common.H2R_SearchFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// id查找玩家
func (this *Player) rpc_call_search_friend_by_id(id int32) (result *rpc_common.H2R_SearchFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 关键字查找玩家
func (this *Player) rpc_call_search_friend_by_key(key string) (result *rpc_common.H2R_SearchFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 通过ID申请好友
func (this *Player) rpc_call_add_friend(add_id int32) (result *rpc_common.H2R_AddFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 通过昵称申请好友
func (this *Player) rpc_call_add_friend_by_name(add_name string) (result *rpc_common.H2R_AddFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 同意或拒绝好友申请
func (this *Player) rpc_call_agree_add_friend(from_id int32, is_agree bool) (result *rpc_common.H2R_AgreeAddFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 删除好友
func (this *Player) rpc_call_remove_friend(player_id int32) (result *rpc_common.H2R_RemoveFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 删除好友2
func (this *Player) rpc_call_remove_friend2(friend_id int32) (result *rpc_common.H2H_RemoveFriendResult) {
	var args = rpc_common.H2H_RemoveFriend{}
	args.FromPlayerId = this.Id
	args.ToPlayerId = friend_id
	result = &rpc_common.H2H_RemoveFriendResult{}
	err := hall_server.rpc_call_hall2hall(friend_id, "H2H_FriendProc.RemoveFriend", args, result)
	if err != nil {
...
// 获取好友信息
func (this *Player) rpc_call_get_friend_info(player_id int32) (result *rpc_common.H2R_GetFriendInfoResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取好友信息2
func (this *Player) rpc_call_get_friend_info2(player_id int32) (result *rpc_common.H2H_GetFriendInfoResult) {
	arg := &rpc_common.H2H_GetFriendInfo{}
	arg.PlayerId = player_id
	result = &rpc_common.H2H_GetFriendInfoResult{}
	err := hall_server.rpc_call_hall2hall(player_id, "H2H_FriendProc.GetFriendInfo", arg, result)
	if err != nil {
...
// 赠送友情点
func (this *Player) rpc_call_give_friend_points(player_id int32) (result *rpc_common.H2H_GiveFriendPointsResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 刷新友情点
func (this *Player) rpc_call_refresh_give_friend_point(friend_id int32) (result *rpc_common.H2H_RefreshGiveFriendPointsResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 好友聊天
func (this *Player) rpc_call_friend_chat(player_id int32, message []byte) (result *rpc_common.H2H_FriendChatResult) {
	args := &rpc_common.H2H_FriendChat{}
	args.FromPlayerId = this.Id
	args.ToPlayerId = player_id
	args.Message = message
	result = &rpc_common.H2H_FriendChatResult{}
	err := hall_server.rpc_call_hall2hall(player_id, "H2H_FriendProc.Chat", args, result)
	if err != nil {
...
// rpc请求 获取好友的关卡数据
func (p *Player) rpc_call_get_friends_stage_info(stage_id int32) (result *rpc_common.H2R_FriendsStagePassDataResult) {
...
// 点赞
func (p *Player) rpc_call_zan_player(player_id int32) (result *rpc_common.H2H_ZanPlayerResult) {
	args := &rpc_common.H2H_ZanPlayer{}
	args.FromPlayerId = p.Id
	args.ToPlayerId = player_id
	result = &rpc_common.H2H_ZanPlayerResult{}
	err := hall_server.rpc_call_hall2hall(player_id, "H2H_PlayerProc.Zan", args, result)
	if err != nil {
...
func (p *Player) rpc_call_zan_player2(player_id int32) (result *rpc_common.H2H_ZanPlayerResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 寄养猫到好友的寄养所
func (p *Player) rpc_call_foster_cat_to_friend(friend_id int32, cat_id int32) (result *rpc_common.H2H_FosterCat2FriendResult) {
	...
	err := hall_server.rpc_call_hall2hall(friend_id, "H2H_FosterProc.SetCat2Friend", args, result)
	if err != nil {
...
// 结算好友寄养猫的收益
func (p *Player) rpc_call_foster_settlement_to_friend(friend_id int32, cat_id int32, cat_exp int32, items map[int32]int32) (result *rpc_common.H2H_FosterSettlement2FriendResult) {
	...
	err := hall_server.rpc_call_hall2hall(friend_id, "H2H_FosterProc.Settlement2Friend", args, result)
	if err != nil {
...
// 结算好友的寄养所
func (p *Player) rpc_call_foster_settlement_playerscat_with_friend(friend_id int32) (result *rpc_common.H2H_FosterSettlementPlayersCatWithFriendResult) {
	args := &rpc_common.H2H_FosterSettlementPlayersCatWithFriend{}
	args.FromPlayerId = p.Id
	args.ToPlayerId = friend_id
	result = &rpc_common.H2H_FosterSettlementPlayersCatWithFriendResult{}
	err := hall_server.rpc_call_hall2hall(friend_id, "H2H_FosterProc.SettlementPlayersCatWithFriend", args, result)
	if err != nil {
...
// 获得寄养在好友的猫
func (p *Player) rpc_call_foster_get_cat_on_friend(friend_id int32, cat_id int32) (result *rpc_common.H2H_FosterGetCatInfoOnFriendResult) {
	args := &rpc_common.H2H_FosterGetCatInfoOnFriend{}
	args.FromPlayerId = p.Id
	args.FromPlayerCatId = cat_id
	args.ToPlayerId = friend_id
	result = &rpc_common.H2H_FosterGetCatInfoOnFriendResult{}
	err := hall_server.rpc_call_hall2hall(friend_id, "H2H_FosterProc.GetCatOnFriend", args, result)
	if err != nil {
...
// 获得寄养在好友的猫2
func (p *Player) rpc_call_foster_get_cat_on_friend2(friend_id int32, cat_id int32) (result *rpc_common.H2H_FosterGetCatInfoOnFriendResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取玩家的寄养所
func (p *Player) rpc_call_foster_get_player_foster(player_id int32) (result *rpc_common.H2H_FosterGetPlayerFosterDataResult) {
	args := &rpc_common.H2H_FosterGetPlayerFosterData{}
	args.FromPlayerId = p.Id
	args.ToPlayerId = player_id
	result = &rpc_common.H2H_FosterGetPlayerFosterDataResult{}
	err := hall_server.rpc_call_hall2hall(player_id, "H2H_FosterProc.GetPlayerFosterData", args, result)
	if err != nil {
...
// 获取玩家的寄养所2
func (p *Player) rpc_call_foster_get_player_foster2(player_id int32) (result *rpc_common.H2H_FosterGetPlayerFosterDataResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取有寄养空位的好友
func (p *Player) rpc_call_foster_get_empty_slot_friend_info(friend_id int32) (result *rpc_common.H2H_FosterGetEmptySlotFriendInfoResult) {
	args := &rpc_common.H2H_FosterGetEmptySlotFriendInfo{}
	args.FromPlayerId = p.Id
	args.ToPlayerId = friend_id
	result = &rpc_common.H2H_FosterGetEmptySlotFriendInfoResult{}
	err := hall_server.rpc_call_hall2hall(friend_id, "H2H_FosterProc.GetEmptySlotFriendInfo", args, result)
	if err != nil {
...
// 获取有寄养空位的好友2
func (p *Player) rpc_call_foster_get_empty_slot_friend_info2(friend_id int32) (result *rpc_common.H2H_FosterGetEmptySlotFriendInfoResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 排行榜关卡总分更新
func (p *Player) rpc_call_rank_update_stage_total_score(total_score int32) (result *rpc_common.H2R_RankStageTotalScoreResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取关卡总分更新
func (p *Player) rpc_call_ranklist_stage_total_score(rank_start, rank_num int32) (result *rpc_common.H2R_RanklistGetStageTotalScoreResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 排行榜关卡积分更新
func (p *Player) rpc_call_rank_update_stage_score(stage_id, score int32) (result *rpc_common.H2R_RankStageScoreResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取关卡积分更新
func (p *Player) rpc_call_ranklist_stage_score(stage_id, rank_start, rank_num int32) (result *rpc_common.H2R_RanklistGetStageScoreResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 排行榜魅力值更新
func (p *Player) rpc_call_rank_update_charm(charm int32) (result *rpc_common.H2R_RankCharmResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取魅力值排行榜
func (p *Player) rpc_call_ranklist_charm(rank_start, rank_num int32) (result *rpc_common.H2R_RanklistGetCharmResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 排行榜欧气值更新
func (p *Player) rpc_call_rank_update_cat_ouqi(cat_id, ouqi int32) (result *rpc_common.H2R_RankCatOuqiResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取欧气值排行榜
func (p *Player) rpc_call_ranklist_cat_ouqi(rank_start, rank_num, cat_id int32) (result *rpc_common.H2R_RanklistGetCatOuqiResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 排行榜被赞更新
func (p *Player) rpc_call_rank_update_zaned(player_id, zan int32) (result *rpc_common.H2R_RankZanedResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取被赞排行榜
func (p *Player) rpc_call_ranklist_get_zaned(rank_start, rank_num int32) (result *rpc_common.H2R_RanklistGetZanedResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 删除排名
func (p *Player) rpc_call_delete_rank(rank_type int32, param int32) (result *rpc_common.H2R_RankDeleteResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 世界聊天
func (p *Player) rpc_call_world_chat(content []byte) (result *rpc_common.H2H_WorldChatResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 公告
func (p *Player) rpc_call_anouncement(msg_type int32, msg_param int32, msg_text string) (result *rpc_common.H2H_AnouncementResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 拜访玩家基地
func (p *Player) rpc_call_visit_player(player_id int32) (result *rpc_common.H2H_VisitPlayerResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获得玩家宝箱配置ID
func (p *Player) rpc_call_get_friend_chest_table_id(player_id, chest_id int32) (result *rpc_common.H2H_GetPlayerChestTableIdResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 打开好友宝箱
func (p *Player) rpc_call_open_friend_chest(friend_id int32, chest_id int32) (result *rpc_common.H2H_OpenFriendChestResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取玩家猫的数据
func (p *Player) rpc_call_player_cat_info(player_id, cat_id int32) (result *rpc_common.H2H_PlayerCatInfoResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 创建空间
func (p *Player) rpc_call_player_personal_space_create() (result *rpc_common.H2R_PersonalSpaceCreateResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 获取个人空间
func (p *Player) rpc_call_player_get_personal_space(player_id int32) (result *rpc_common.H2R_GetPersonalSpaceResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 修改空间签名
func (p *Player) rpc_call_personal_space_modify_signature(signature string) (result *rpc_common.H2R_PSModifySignatureResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 空间点赞
func (p *Player) rpc_call_personal_space_zan(player_id, pic_id int32) (result *rpc_common.H2R_PSZanResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 拉取空间留言
func (p *Player) rpc_call_pull_personal_space_leave_msg(player_id, pic_id, start_index, msg_num int32) (result *rpc_common.H2R_PSPullLeaveMessagesResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 发送空间留言
func (p *Player) rpc_call_personal_space_send_leave_msg(player_id, pic_id int32, content []byte) (result *rpc_common.H2R_PSSendLeaveMsgResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 删除空间留言
func (p *Player) rpc_call_personal_space_delete_leave_msg(player_id, pic_id, msg_id int32) (result *rpc_common.H2R_PSDeleteLeaveMsgResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 发送空间评论
func (p *Player) rpc_call_personal_space_send_leave_msg_comment(player_id, pic_id, msg_id int32, content []byte) (result *rpc_common.H2R_PSSendLeaveMsgCommentResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 删除空间评论
func (p *Player) rpc_call_personal_space_delete_leave_msg_comment(player_id, pic_id, msg_id, comment_id int32) (result *rpc_common.H2R_PSDeleteLeaveMsgCommentResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
...
// 拉取空间评论
func (p *Player) rpc_call_personal_space_pull_leave_msg_comment(player_id, pic_id, msg_id, start_index, comment_num int32) (result *rpc_common.H2R_PSPullLeaveMessageCommentsResult) {
	rpc_client := get_rpc_client()
	if rpc_client == nil {
		return nil
	}
