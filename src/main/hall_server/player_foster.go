		...
		if cat_items != nil {
			...
			for k, v := range cat_items[i] {
				items[n] = &msg_client_message.ItemInfo{
					ItemCfgId: proto.Int32(k),
					ItemNum:   proto.Int32(v),
				}
				n += 1
			}
		} else {
...
func reg_player_foster_msg() {
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SPullFosterData, C2SPullFosterDataHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterEquipCard, C2SFosterEquipCardHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterUnequipCard, C2SFosterUnequipCardHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterSetCat, C2SFosterSetCatHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterOutCat, C2SFosterOutCatHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterSetCat2Friend, C2SFosterSetCat2FriendHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SGetPlayerFosterCats, C2SGetPlayerFosterCatsHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SPullFosterCatsWithFriend, C2SPullFosterDataWithFriendHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterCardCompose, C2SFosterCardComposeHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SFosterGetEmptySlotFriends, C2SFosterGetEmptySlotFriendsHandler)
}
...
// 结算
func (this *dbPlayerFosterCatColumn) Settlement(is_settle bool, card_start_time int32, card *table_config.XmlFosterItem) (cat_ids []int32, cat_exps []int32, cat_items []map[int32]int32) {
...
func (this *dbPlayerFosterFriendCatColumn) Settlement(friend_id int32) (remain_seconds, cat_exp int32, items map[int32]int32) {
	...
	if used_time >= global_id.FriendFosterHours_27*3600 {
		...
		remain_seconds = global_id.FriendFosterHours_27*3600 - used_time
	}

	return
}

func (this *dbPlayerFosterFriendCatColumn) CheckAndAddFriendCat(friend_id, friend_level int32, friend_name, friend_head string, cat_id, cat_table_id, cat_level, cat_star int32, foster_friend_num int32, card *table_config.XmlFosterItem) int32 {
...
func (this *Player) send_foster_self_data(self_cats []*msg_client_message.FosterCatInfo) {
	...
	response.BuildingId = proto.Int32(this.db.Foster.GetBuildingId())
	response.CardId = proto.Int32(this.db.Foster.GetEquippedCardId())
	response.CardRemainSeconds = proto.Int32(this.db.Foster.GetCardRemainSeconds())
...
func (this *Player) foster_pull_cats_from_friend() (cats_in_friend []*msg_client_message.FosterCatInFriendInfo) {
	...
	for i := 0; i < len(cat_ids); i++ {
		...
		var friend_level, start_card, remain_seconds, cat_exp int32
		var friend_name, friend_head string
		...
		if friend != nil {
			...
			friend_head = friend.db.Info.GetIcon()
		...
		d := &msg_client_message.FosterCatInFriendInfo{
			...
			StartCardId:   proto.Int32(start_card),
			RemainSeconds: proto.Int32(remain_seconds),
			CatExp:        proto.Int32(cat_exp),
			Items:         get_items,
		}
...
func (this *Player) foster_data_pull_with_friend() int32 {
	...
	response.FosterFriendSlotNum = proto.Int32(this.foster_slot_num_to_friend())
	response.FriendFosteredSlotNum = proto.Int32(this.fostered_slot_num_for_friend())
	this.Send(response)
	return 1
}
...
func (this *Player) compose_foster_card(card_ids []int32) int32 {
	...
	response.DestItemTableId = proto.Int32(dest_card)
	this.Send(response)
...
func (this *Player) foster_settlement_self_cats(is_settle bool, get_cats_msg, get_rewards_msg bool) (self_cats []*msg_client_message.FosterCatInfo, rewards []*msg_client_message.ItemInfo) {
	...
	if cat_ids != nil && len(cat_ids) > 0 {
		if is_settle && cat_exps != nil {
			...
			this.TaskUpdate(table_config.TASK_FINISH_GET_EXP_BY_FOSTER, false, 0, 1)
		}
		...
		if get_cats_msg {
			...
			for i := 0; i < len(self_cats); i++ {
				...
				self_cats[i].StartTime = proto.Int32(t)
			}
		}
	}
	return
...
func (this *Player) foster_build_friends_cats_msg(friend_id int32, remain_seconds int32) *msg_client_message.FosteredFriendCatInfo {
	...
	return &msg_client_message.FosteredFriendCatInfo{
		...
		FriendLevel:   proto.Int32(friend_level),
		FriendHead:    proto.String(friend_head),
		StartCardId:   proto.Int32(card_id),
		RemainSeconds: proto.Int32(remain_seconds),
	}
}
...
func (this *Player) foster_equip_card(building_id int32, card_id int32) int32 {
	...
	response.BuildingId = proto.Int32(building_id)
	response.CardId = proto.Int32(card_id)
	response.CardRemainSeconds = proto.Int32(get_foster_card_remain_seconds(card_id, now_time))
	this.Send(response)
...
func (this *Player) foster_set_cat(building_id int32, cat_id int32) int32 {
	...
	response.BuildingId = proto.Int32(building_id)
	response.CatId = proto.Int32(cat_id)
	this.Send(response)
...
func (this *Player) add_friend_cat_in_foster(friend_id, friend_level int32, friend_name, friend_head string, cat_id, cat_table_id, cat_level, cat_star int32) int32 {
...
func (this *Player) foster_set_cat_friend(friend_id int32, cat_id int32) int32 {
	...
	if friend != nil {
		...
		res := friend.add_friend_cat_in_foster(this.Id, this.db.Info.GetLvl(), this.db.GetName(), this.db.Info.GetIcon(), cat_id, cat_table_id, cat_level, cat_star)
		if res < 0 {
...
func (this *Player) fostered_slot_num_for_friend() int32 {
	...
	player_level := cfg_player_level_mgr.Map[lvl]
	if player_level == nil {
		return 0
	}
	...
	if friend_ids != nil || len(friend_ids) > 0 {
		for i := 0; i < len(friend_ids); i++ {
			...
			if friend != nil {
				...
				d.FosterCardId = proto.Int32(friend.db.Foster.GetEquippedCardId())
			} else {
				...
				d := &msg_client_message.FriendInfo{
					PlayerId:     proto.Int32(friend_ids[i]),
					Level:        proto.Int32(result.ToPlayerLevel),
					Name:         proto.String(result.ToPlayerName),
					Head:         proto.String(result.ToPlayerHead),
					VipLevel:     proto.Int32(result.ToPlayerVipLevel),
					LastLogin:    proto.Int32(result.ToPlayerLastLogin),
					FosterCardId: proto.Int32(result.FosterCardId),
				}
				friends = append(friends, d)
			}
		}
...
func (this *Player) get_player_foster_cats(player_id int32) int32 {
	...
	if player != nil {
		...
		for i := 0; i < len(result.PlayerCats); i++ {
			d := &msg_client_message.FosterPlayerCatInfo{
				CatTableId: proto.Int32(result.PlayerCats[i].CatTableId),
				CatLevel:   proto.Int32(result.PlayerCats[i].CatLevel),
				CatStar:    proto.Int32(result.PlayerCats[i].CatStar),
			}
			cats = append(cats, d)
		}
		for i := 0; i < len(result.PlayerFriendCats); i++ {
			...
			d := &msg_client_message.FosteredFriendCatInfo{
				StartCardId:   proto.Int32(c.StartCardId),
				...
				FriendName:    proto.String(c.PlayerName),
				FriendLevel:   proto.Int32(c.PlayerLevel),
				FriendHead:    proto.String(c.PlayerHead),
			}
	...
	response := &msg_client_message.S2CGetPlayerFosterCatsResult{
		...
		CardRemainSeconds: proto.Int32(remain_seconds),
		Cats:              cats,
		FriendCats:        friend_cats,
		FosteredSlotNum:   proto.Int32(fostered_num),
	}
	this.Send(response)
...
func C2SPullFosterDataHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SPullFosterData)
	if req == nil {
...
func C2SPullFosterDataWithFriendHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SPullFosterCatsWithFriend)
	if req == nil {
...
func C2SFosterEquipCardHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterEquipCard)
	if req == nil {
...
func C2SFosterUnequipCardHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterUnequipCard)
	if req == nil {
		log.Error("C2SFosterUnequipCardHandler proto invalid")
		return -1
	}
	return p.foster_unequip_card(req.GetBuildingId())
}

func C2SFosterSetCatHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterSetCat)
	if req == nil {
		log.Error("C2SFosterSetCatHandler proto invalid")
		return -1
	}
	return p.foster_set_cat(req.GetBuildingId(), req.GetCatId())
}

func C2SFosterOutCatHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterOutCat)
	if req == nil {
		log.Error("C2SFosterOutCatHandler proto invalid")
		return -1
	}
	return p.foster_out_cat(req.GetBuildingId(), req.GetCatId())
}

func C2SFosterSetCat2FriendHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterSetCat2Friend)
	if req == nil {
		log.Error("C2SFosterSetcat2Friend proto invalid")
		return -1
	}
	return p.foster_set_cat_friend(req.GetFriendId(), req.GetCatId())
}

func C2SFosterGetEmptySlotFriendsHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterGetEmptySlotFriends)
	if req == nil {
		log.Error("C2SFosterGetEmptySlotFriendsHandler proto invalid")
		return -1
	}
	return p.foster_get_empty_slot_friends()
}

func C2SGetPlayerFosterCatsHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SGetPlayerFosterCats)
	if req == nil {
		log.Error("C2SGetPlayerFosterCatsHandler proto invalid")
		return -1
	}
	return p.get_player_foster_cats(req.GetPlayerId())
}

func C2SFosterCardComposeHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SFosterCardCompose)
	if req == nil {
		log.Error("C2SFosterCardComposeHandler proto invalid")
		return -1
	}
