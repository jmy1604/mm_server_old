...
func is_cat_level_max(next_level int32, cat *table_config.XmlCharacterItem) bool {
...
func cat_level_need_exp(level int32, cat *table_config.XmlCharacterItem) int32 {
...
func (this *Player) cat_level_up(next_level int32, cat_id int32, cat *table_config.XmlCharacterItem, curr_food int32) (ok bool, cost_food int32) {
...
func (this *Player) feed_cat(cat_id int32, food int32, add_exp int32, is_critical bool) (int32, int32, int32) {
	...
	// update task
	this.TaskUpdate(table_config.TASK_FINISH_CAT_FEED, false, 0, 1)
	if old_level != curr_level {
		this.TaskUpdate(table_config.TASK_FINISH_CAT_LEVEL_UP, true, curr_level, 1)
		// update ranking list
...
func (this *Player) cat_upstar(cat_id int32, cost_cat_ids []int32) int32 {
	...
	msg.CatId = proto.Int32(cat_id)
	msg.CatStar = proto.Int32(curr_star)
	this.Send(msg)

	// update task
	this.TaskUpdate(table_config.TASK_FINISH_CAT_UP_STAR, false, curr_star, 1)
...
func (this *Player) cat_skill_levelup(cat_id int32, cost_cat_ids []int32) int32 {
	...
	msg.CatId = proto.Int32(cat_id)
	msg.SkillLevel = proto.Int32(up_level)
	this.Send(msg)

	// update task
	this.TaskUpdate(table_config.TASK_FINISH_CAT_UP_SKILL_LEVEL, true, up_level, 1)
...
func (this *Player) rename_cat(cat_id int32, new_nick string) int32 {
	...
	msg := &msg_client_message.S2CRenameCatNickResult{}
	msg.CatId = proto.Int32(cat_id)
	msg.NewNick = proto.String(new_nick)
	this.Send(msg)
...
func (this *Player) lock_cat(cat_id int32, is_lock bool) int32 {
	...
	msg := &msg_client_message.S2CLockCatResult{}
	msg.CatId = proto.Int32(cat_id)
	msg.Locked = proto.Bool(is_lock)
	this.Send(msg)
...
func (this *Player) decompose_cat(cat_ids []int32) int32 {
	...
	response := &msg_client_message.S2CDecomposeCatResult{}
	response.CatId = cat_ids
	response.GetSoulStone = proto.Int32(add_stone)
	this.Send(response)
...
func get_cat_coin_ability(cat *table_config.XmlCharacterItem, d *dbPlayerCatData) int32 {
...
func get_cat_match_ability(cat *table_config.XmlCharacterItem, d *dbPlayerCatData) int32 {
...
func get_cat_explore_ability(cat *table_config.XmlCharacterItem, d *dbPlayerCatData) int32 {
...
func (this *Player) get_player_cat_info(player_id int32, cat_id int32) int32 {
	...
	response := &msg_client_message.S2CPlayerCatInfoResult{
		...
		CatSkillLevel: proto.Int32(cat_skill_level),
		CatAddCoin:    proto.Int32(cat_add_coin),
		CatAddMatch:   proto.Int32(cat_add_match),
		CatAddExplore: proto.Int32(cat_add_explore),
	}
	this.Send(response)
