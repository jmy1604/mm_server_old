...
func (this *Player) check_limited_days_shop_items(days int32, limited_items *table_config.ShopLimitedItems) bool {
	// 刷新全服商品
	...
	if !global_config_mgr.GetShopTimeChecker().IsArrival(last_save_time, days) {
		return false
	}
