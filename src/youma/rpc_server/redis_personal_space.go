...
const REDIS_KEY_PERSONAL_SPACE_BASE_DATA = "mm:personal_space_base_data:player_id"
const REDIS_KEY_PERSONAL_SPACE_LEAVE_MESSAGES = "mm:personal_space_leave_messages:player_id+msg_id"
const REDIS_KEY_PERSONAL_SPACE_LEAVE_MESSAGE_COMMENTS = "mm:personal_space_leave_message_comments:player_id+msg_id+comment_id"
const REDIS_KEY_PERSONAL_SPACE_PICTURE_DATA = "mm:personal_space_picture_data:player_id+pic_id"
const REDIS_KEY_PERSONAL_SPACE_PIC_LEAVE_MESSAGES = "mm:personal_space_picture_leave_messages:player_id+pic_id+msg_id"
const REDIS_KEY_PERSONAL_SPACE_PIC_LEAVE_MESSAGE_COMMENTS = "mm:personal_space_picture_leave_message_comments:player_id+pic_id+msg_id+comment_id"
const REDIS_KEY_PERSONAL_SPACE_PIC_ZAN = "mm:personal_space_picture_zan:player_id+pic_id"
